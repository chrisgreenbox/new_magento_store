...
//                         </span>';
                ...
                if ($_value->getDescription() && $helper->isOptionVariationDescriptionEnabled()) {
                    ...
                    $selectHtml .= '<script type="text/javascript">new Tagtip("select_description_'.$_option->getId().'_'.$_value->getId().'", "'.$this->jsEscape($_value->getDescription()).'", {align: "rightMiddle"});</script>';
                }
